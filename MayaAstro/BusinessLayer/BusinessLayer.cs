...
namespace MayaAstro.BusinessLayer
{
    ...
    public partial class BusinessLayer : IBusinessLayer
    {
        ...
        public BusinessLayer(IConfiguration configuration, Microsoft.AspNetCore.Http.IHttpContextAccessor HttpContextAccessor)
        {
            ...
            BaseAPIUrl = "http://localhost:22950/";
        }
        ...
        //            RootName = axn.Models.Common.Constants.ManageAdmin;
        //            break;
        //        case (int)Roles.HR:
        //            RootName = axn.Models.Common.Constants.ManageHR;
        //            break;
        //        case (int)Roles.Employee:
        //            RootName = axn.Models.Common.Constants.ManageEmployee;
        //            break;
        //        default:
        //            break;
        //    }
        ...
        //{
        //    var ProfilePhoto = "";
        //    if (!string.IsNullOrEmpty(httpContextAccessor.HttpContext.Session.GetString(axn.Models.Common.Constants.ProfilePhoto)))
        //    {
        //        ProfilePhoto = "/" + axn.Models.Common.Constants.EmployeePhotoPath + httpContextAccessor.HttpContext.Session.GetString(axn.Models.Common.Constants.EmployeeID) + "/" + httpContextAccessor.HttpContext.Session.GetString(axn.Models.Common.Constants.ProfilePhoto);
        //    }
        //    else
        //    {
        //        ProfilePhoto = axn.Models.Common.Constants.NoImagePath;
        //    }
        //    return ProfilePhoto;
        //}
    }
